...
const map = [
  ...
  ["scripts/lib/docs-index.mjs", "scripts/lib/docs-index.mjs"],
  ["scripts/lib/project-catalog.mjs", "scripts/lib/project-catalog.mjs"],
  ["scripts/lib/catalog-search.mjs", "scripts/lib/catalog-search.mjs"],
  ["scripts/lib/discovery-map.mjs", "scripts/lib/discovery-map.mjs"],
  ["scripts/lib/environment-check.mjs", "scripts/lib/environment-check.mjs"],
  ["scripts/lib/governance-update.mjs", "scripts/lib/governance-update.mjs"],
  ["scripts/project-catalog.mjs", "scripts/project-catalog.mjs"],
  ["scripts/discovery-map.mjs", "scripts/discovery-map.mjs"],
  ["scripts/environment-check.mjs", "scripts/environment-check.mjs"],
  ["scripts/governance-update.mjs", "scripts/governance-update.mjs"],
