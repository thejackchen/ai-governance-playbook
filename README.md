...
> v2(2026-07)全面换代:内容来自一次真实生产项目迁移 + 三组对照实验的胜出方案,不是理念推演。
...
> **「读 `https://github.com/thejackchen/ai-governance-playbook` 的 setup.md,为本项目建立治理;存量项目按 MIGRATION.md 对齐;完成后按 SELF-CHECK.md 自检,并向我交付安装报告。」**
